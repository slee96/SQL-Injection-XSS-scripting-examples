...
<table width="492" border="0" cellspacing="0" cellpadding="0">
  <tr> 
    <td><img src="/images/itinerary.gif" width="506" height="380" border="0" usemap="#Map"></td>
  </tr>
  <tr> 
  ...
  <tr> 
	...
	<input type=hidden name="fromPort" value="New York">
	<input type=hidden name="toPort" value="San Francisco">
	<input type=hidden name="passCount" value="1">
	<input type=hidden name="toDay" value="31">
	<input type=hidden name="toMonth" value="12">
	<input type=hidden name="fromDay" value="29">
	<input type=hidden name="fromMonth" value="12">
	<input type=hidden name="servClass" value="Coach">
        </form>
    </td>
  </tr>
</table>
  ...
  <map name="Map">
    <area shape="rect" coords="38,325,471,364" href="mercurywelcome.php">
  </map>
</body>
				</td>
				</tr>
