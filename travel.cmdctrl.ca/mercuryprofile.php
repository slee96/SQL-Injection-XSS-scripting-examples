...
<table border="1" bordercolor="#000000" cellpadding="0" cellspacing="0"
  >
  <tr>
    <td class=mouseOut width="73" height="33" align="center" onMouseOut="changeStyle(this, 'mouseOut')" onMouseOver="changeStyle(this, 'mouseOver')"><a href="mercurysignon.php"  >SIGN-OFF</a></td>
...
<table width="492" border="0" cellspacing="0" cellpadding="0">
  <tr> 
    <td><img src="/images/masts/mast_editprofile.gif" width="492" height="30"></td>
  </tr>
  <tr> 
  ...
  <tr> 
    <td> 
      <p class="style1"> Use this form to review and update your account information.</td>
  </tr>
  <tr>
    <td><img src="/images/spacer.gif" width="1" height="10"></td>
  </tr>
	...
	<input type=hidden name=mercury value=process>
        <table cellpadding="2" border=0 width="100%">
          ...
          <tr> 
            ...
            <td> 
              <input maxlength="64" name="email" size="35">
            </td>
          </tr>
          <tr bgcolor="#CCCCCC"> 
          ...
          <tr> 
            <td colspan="2" align=CENTER> &nbsp;&nbsp;<a href="mercurywelcome.php"><img src="images/profile_submit.gif" width="69" height="33" border="0"></a></td>
          </tr>
        </table>
      </form>
    </td>
