...
<html>
<head>
<title>Sign-on: Mercury Tours</title>
...
<table width="492" border="0" cellspacing="0" cellpadding="0">
  <tr> 
    <td><img src="/images/masts/mast_signon.gif" width="492" height="30"></td>
  </tr>
  <tr> 
  ...
  <tr> 
    <td> 
      <p><font face="Arial, Helvetica, sans-serif" size="2"><b>Welcome back to 
        Mercury Tours!</b> Enter your user information to access the member-only 
        areas of this site. If you don't have a log-in, please fill out the <a href="mercuryregister.php">registration 
        form</a>. </font>
  ...
  <tr> 
	...
	<input type=hidden name=action value=process>
        <table cellpadding="2" border=0 width="100%">
          <tr> 
            <td align=right><font face="Arial, Helvetica, sans-serif" size="2"><b>User 
              Name: </b></font></td>
          ...
          <tr> 
            <td align=right><font face="Arial, Helvetica, sans-serif" size="2"><b>Password: 
              </b></font></td>
            <td> 
		...
		<input type=image name=login value=Login alt=Login border=0 src='/images/forms/submit.gif?osCsid=cdfdf2ab93853717b3da9da1d0a8ae5c' width=60 height=23></a></td>
          </tr>
        </table>
      </form>
